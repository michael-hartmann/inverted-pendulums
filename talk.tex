...
\frame {
    ...
    \approx \frac{1}{2} mL^2 \left( 2\dot\theta_1^2  + \dot\theta_2^2 + 2\dot\theta_1\dot\theta_2\right)
    \end{equation}
    ...
    \begin{equation}
    \nonumber
    \mathcal{L} \approx \frac{1}{2} mL^2 \left( 2\dot \Delta_1^2  + \dot \Delta_2^2 + 2\dot \Delta_1\dot \Delta_2\right) + mgL\left( \Delta_1^2 + \frac{\Delta_2^2}{2} \right)
    \end{equation}
    }
...
\frame {
    ...
    $$\frac{\sqrt{gNL}}{\omega_0} \lesssim \epsilon \lesssim 0.154 \frac{L}{N}$$
        \visible<3>
        {
        \vfill
        \begin{center}
...
\frame {
    ...
    \begin{figure}
        \centering
        \href{https://www.youtube.com/watch?v=gnn21smGVrQ&feature=youtu.be&t=54}{\includegraphics[width=0.8\textwidth]{images/youtube.png}}
...
\frame {
    ...
    \begin{center}
    {
        \href{https://www.youtube.com/watch?v=ncSjOWbx79I}{\includegraphics[height=0.4\textheight]{images/pink.png}}
    }
    \end{center}
    ...
    \begin{flushright}
    \href{https://github.com/michael-hartmann/inverted-pendulums}{Vortrag auf github \includegraphics[scale=0.025]{images/github.png}}
    \end{flushright}
}
