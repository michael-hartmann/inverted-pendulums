...
\frame {
    ...
    \begin{center}
    \includegraphics[scale=0.7]{images/Indian-Rope-Trick.jpg} \quad
    \includegraphics[scale=0.7]{images/Indian-Rope-Trick_2.jpg}
    \end{center}
...
\frame {
    ...
    $$\omega_\mathrm{min} \approx 1.2\sqrt{\frac{g}{L}}, \qquad \omega_\mathrm{max} \approx \frac{\pi}{2} \left(N-\nicefrac{1}{4}\right) \sqrt{\frac{g}{L}}$$

    \vfill

    Stabilitätsbedingung
    \only<1> { $$\frac{1.18}{\omega_0} \sqrt{\frac{g}{L}} < \frac{\epsilon}{L} < \frac{0.182}{\left(N-\nicefrac{1}{4}\right)^2}$$ }
    \only<2> { $$\frac{1.18}{\omega_0} \sqrt{\frac{g}{L}} < \frac{\epsilon}{L} < \frac{0.182}{\left(N-\nicefrac{1}{4}\right)^2} \overset{N\to\infty}{=} 0 \quad \text\lightning$$ }
}
