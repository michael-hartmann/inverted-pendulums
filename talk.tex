...
\frame {
    \frametitle{Normalkoordinaten ($\theta_1\approx\theta_2\approx\pi$)}
    ...
    Potentielle Energie ($X_j \equiv \theta_j-\pi$)
    \begin{equation}
    \nonumber
    V = mgL\left(3-2\cos\theta_1-\cos\theta_2\right) \equiv mgL\left(6-X_1^2-\frac{X_2^2}{2}\right)
    \end{equation}
    ...
    \begin{equation}
    \nonumber
    \mathcal{L} \approx \frac{1}{2} mL^2 \left( 2\dot X_1^2  + \dot X_2^2 + \dot X_1\dot X_2\right) + mgL\left( X_1^2 + \frac{X_2^2}{2} -6\right)
    \end{equation}
    ...
    \begin{equation}
    \nonumber
    \frac{\mathrm{d}}{\mathrm{d}t} \frac{\partial\mathcal{L}}{\partial\dot X_j} - \frac{\partial\mathcal{L}}{\partial X_j} = 0
    \end{equation}
